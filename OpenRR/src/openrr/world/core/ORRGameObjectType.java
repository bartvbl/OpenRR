...
public enum ORRGameObjectType {
	...
	//characters
	ROCK_RAIDER				(new Enum<?>[]{HEALTH, ROCK_RAIDER_APPEARANCE, GRAVITY, ROCK_RAIDER_TASK_EXECUTOR, ROCK_RAIDER_MOVEMENT}), 
	...
	//buildings
	TOOL_STORE				(new Enum<?>[]{TOOL_STORE_APPEARANCE, GRAVITY, ORE_ACCEPTING_BUILDING, TOOL_STORE_TASK_EXECUTOR}),
	TELEPORT_PAD			(new Enum<?>[]{TELEPORT_PAD_APPEARANCE, GRAVITY, TOOL_STORE_TASK_EXECUTOR}),//TASK_EXECUTOR
	...
	ORE_REFINERY			(new Enum<?>[]{ORE_REFINERY_APPEARANCE, GRAVITY, ORE_ACCEPTING_BUILDING}),
