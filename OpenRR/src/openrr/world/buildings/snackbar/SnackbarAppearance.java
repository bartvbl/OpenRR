package openrr.world.buildings.snackbar;
...
public class SnackbarAppearance extends Appearance {
	public SnackbarAppearance(GameObject gameObject) {
		super(ORRPropertyType.SNACKBAR_APPEARANCE, ResourceType.lxfmlModel, "canteen", gameObject);
	}
